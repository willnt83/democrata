...
class WMSProdPosicoes extends Component {
    constructor(props) {
        super()
        props.setPageTitle('WMS Produtos - Posição do Armazém')
    }
    ...
    requestCreateUpdatePosicaoArmazem = (request) => {
        ...
        axios.post(this.props.backEndPoint + '/wms-produtos/createUpdatePosicao', request)
        .then(res => {
...
export default connect(MapStateToProps, mapDispatchToProps)(Form.create()(WMSProdPosicoes))