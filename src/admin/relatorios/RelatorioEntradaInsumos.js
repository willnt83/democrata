...
class RelatorioEntradaInsumos extends Component {
    constructor(props) {
        super()
        props.setPageTitle('Relatório - Entrada de Insumos')
    }
    ...
    generateReport = () => {
        this.props.form.validateFieldsAndScroll((err, values) => {
            if(!err){
                ...
                axios
                .get(this.props.backEndPoint + '/reportEntradaInsumos?dataInicial='+values.dataInicial.format('YYYY-MM-DD')+'&dataFinal='+values.dataFinal.format('YYYY-MM-DD'))
                .then(res => {
                    if(res.data.success){
...
export default connect(MapStateToProps, mapDispatchToProps)(Form.create()(RelatorioEntradaInsumos))