...
class RelatorioFuncionariosCadastrados extends Component {
    constructor(props) {
        super()
        props.setPageTitle('Relatório - Funcionários Cadastrados')
    }
    ...
    generateReport = () => {
        ...
        axios
        .get(this.props.backEndPoint + '/reportFuncionariosCadastrados')
        .then(res => {
            if(res.data.success){
...
export default connect(MapStateToProps, mapDispatchToProps)(RelatorioFuncionariosCadastrados)