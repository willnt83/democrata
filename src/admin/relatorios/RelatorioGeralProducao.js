...
class RelatorioGeralProducao extends Component {
    constructor(props) {
        super()
        props.setPageTitle('Relatório - Geral de Lançamento de Produção')
    }
    ...
    generateReport = () => {
        this.props.form.validateFieldsAndScroll((err, values) => {
            if(!err){
                ...
                axios
                .get(this.props.backEndPoint + '/reportGeralLancamentoProducao?dataInicial='+values.dataInicial.format('YYYY-MM-DD')+'&dataFinal='+values.dataFinal.format('YYYY-MM-DD'))
                .then(res => {
                    if(res.data.success){
