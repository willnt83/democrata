...
class RelatorioFuncionariosPontuacoes extends Component {
    constructor(props) {
        super()
        props.setPageTitle('Relatório - Pontuações por Funcionários')
    }
    ...
    generateReport = () => {
        this.props.form.validateFieldsAndScroll((err, values) => {
            if(!err){
                ...
                axios
                .get(this.props.backEndPoint + '/reportFuncionariosPontuacoes?dataInicial='+values.dataInicial.format('YYYY-MM-DD')+'&dataFinal='+values.dataFinal.format('YYYY-MM-DD'))
                .then(res => {
                    if(res.data.success){
