...
class ConferenciaProducao extends Component{
    ...
    requestGetCodigosDeBarrasProducao = (idProducao) => {
        axios
        .get(this.props.backEndPoint + '/getCodigosDeBarrasProducao?idProducao='+idProducao)
        .then(res => {
            this.setState({
    ...
    producaoSelecionada = () => {
        this.props.form.validateFieldsAndScroll((err, values) => {
            if(!err){
                ...
                this.requestGetCodigosDeBarrasProducao(values.producao)
            }
            else{
